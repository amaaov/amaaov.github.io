...
Music can begin with an object moving through space and a relation that fails on schedule. It can also begin with neither object nor sound: sitting, breathing, listening to a radiator, watching whether thought reaches for a pattern. A poi, a ball, a staff, a hand, a rope, a cursor, a line of code, a breath, a spoken instruction, a pause, a failure to move, a sound that arrives too late, or no sound at all may be material when the situation offers them. The usual training path runs through repertoire, technique, known works, tradition. That path teaches hands. Another path teaches relations between movement, sound, attention, intention, and error inside the situation you are actually inside.
...
A scene begins with the situation in front of you: what is actually here, what this body can do today, what material is in the room, and what relation you want to test in this pass. The questions are prompts for one experiment, an open door for this pass.
...
Behavioral relations give the sound system character toward movement: mirror, imitation, following, resistance, ignoring, provocation, dialogue, conflict, autonomy. Style often lives in that character as obedient, late, stubborn, fragile, forgetful, too early, generous, dry, noisy, silent, or unstable.
...
When something breaks, pause before the fix and ask what you expected, what happened, where the difference is, what check would have caught this, and what habit allowed it. Write the check, then fix. Break → observation → check → correction → habit named. A break becomes useful when it changes the next pass.
