...
**Language:** Finnish
**HTML:** [20260612120000_o_modalnosti_krucheniya_fi.html](20260612120000_o_modalnosti_krucheniya_fi.html)
**Licence:** [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)

---

Siteswapin rajoitukset ja muunnokset joustavilla rekvisiitoilla

Tiivistelmä

Artikkeli tarkastelee siteswapin — jongleerauksen rytmisen notaation — soveltuvuuden rajoja joustavilla ja vääntövoimaan perustuvilla rekvisiitoilla. Siinä osoitetaan, että pitoaika-parametrin ja tilallisen tarkkuuden puute tekee notaatiosta tarkan jäykille esineille, mutta riittämättömän poi:lle ja sekamuotoisille ryhmille.

i

§ 1

## Siteswap abstraktina mallina

Määritelmä

Siteswap on abstrakti malli jongleerausnotaatiolle, joka kirjaa esineiden rytmisen järjestyksen vuorovaikutuspisteessä. Se määrittää, kuinka monen iskun kuluttua kyseinen esine on jälleen käytettävä.

Siteswap ei kuitenkaan kuvaa liikerataa, tilallista asettelua tai esityksen fysikaalisia ominaisuuksia. Se toimii siten rytmisenä kaavana, josta puuttuu tilallinen tarkkuus ja kineettinen yksityiskohtaisuus.
...
Poi:ssa tilanne on toinen: pito ja siirto eivät ole erillisiä tapahtumia vaan jatkuva kehollinen toiminta, johon kuuluu impulssin siirto, pyörimisen ylläpito ja tasojen hallinta. Painopiste siirtyy heiton hetkestä liikkeen ylläpitovaiheeseen, joka perinteisessä notaatiossa jätetään kokonaan pois.
...
Tämän seurauksena siteswap menettää kuvailevan tarkkuutensa ja jää vain tapahtumakaavioksi, joka on irrotettu fysikaalisesta kontekstista.
...
Tämä näkyy vielä selvemmin monimutkaisissa kuvioissa, kuten 5223. Siteswap-järjestelmässä tämä on korkeiden, pidätys- ja keskikorkeiden heittojen vuorottelua. Poi:ssa sama sarja voidaan tulkita liikkeeksi, jossa «2» on aktiivinen pyörimisvaihe ennen tason vaihtoa ja «5» on voimistettu kiihdytys.
...
Kaikki edellä sanottu antaa perusteen päätellä, että siteswap, vaikka tehokas abstraktio, ei ole yleispätevä liikkeen kuvausjärjestelmä. Sen soveltuvuus joustaviin ja vääntövoimaan perustuviin järjestelmiin vaatii uudelleenajattelua: joko laajennettujen mallien kehittämistä lisäparametreilla tai tietoista käyttöalueen rajoittamista.

Johtopäätös

Nykyisessä muodossaan siteswap täyttää edelleen tärkeän viestinnällisen ja rytmisen tehtävän, mutta sitä ei voi käyttää ainoana kuvaajana kehollisessa harjoituksessa, joka perustuu jatkuviin, vaiheisiin sidottuihin liikkeisiin.

Siteswap on siten vähemmän kuvauskieli kuin järjestämistyökalu. Se kertoo esiintyjälle, milloin seuraavan vuorovaikutusteon esineen kanssa pitäisi tapahtua, mutta jättää avoimeksi kysymyksen siitä, miten tämä teko toteutetaan. Tämä tekee siitä arvokkaan rytmisenä ruudukkona, mutta rajallisen liikemallina, erityisesti lajeissa, joissa heiton ja pyörimisen välinen raja on hämärtynyt.
