...
## The first restriction: juggling
...
Teaching culture already supports that sharper signal. Bow’s published [No Beat Course](https://poitutorials.com/series/no-beat-course-by-bow-juggler/) opens on no-beat cascade before forward cascade, then windmill, basic siteswap, halfshower, and four poi. The hundred-siteswap video builds advanced rhythm under a single backward no-beat framing in its catalogue. Living curriculum is evidence that a sport programme can grow siteswap depth inside a fixed modality; it is still far from a federation table.

## Planes in space, body names, and transition class

Names such as wheelplane and wallplane always belong to the relation of body and prop. For comparing transitions, sport needs one further record: whether the poi orbits stay nearly fixed in space while the body turns. The same physical orbit, renamed relative to the body, changes class when the performer turns; the record is there to tell a body turn from a redirection of the planes. The distinction yields three transition mechanisms that can look identical at the destination and differ completely as skills.

In an orbit-preserving, body-mediated transition the poi planes stay approximately fixed in space while the body turns ninety degrees: the body-relative plane class changes, for example from wheelplane to wallplane. The orbits continue in space, but relative to the body the task is already different, since a no-beat cascade in wheelplane and a no-beat cascade in wallplane are separate graded tasks, and a halfshower in either plane is a different pattern again. True wallplane backward no-beat cascade is itself hard and, for most people, nearly impossible without body throws or behind-the-back throws; crossed-hand wallplane paths usually cease to be a cascade and become a spiral, itself a further pattern. In ordinary sport work, odd wallplane counts (3, 5, 7) run as extra-spin patterns: wallplane synchronous 3, halfshower, wallplane synchronous 5. No-beat wallplane on those odd counts is not required. Even wallplane counts (2, 4, 6, 8) are mostly one-hand pair control; no-beat or extra-spin may both be legal when declared, and rising siteswap difficulty shows up as hard hand and body positions. Early grades should therefore keep backward no-beat 3 on the side planes and use extra-spin wallplane synchronous 3 and halfshower for front-wall work; continuous orbit-preserving body turns belong later, after body throws are established. In living practice the continuous turn is almost never clean hand-in-front juggling: crossing throws and behind-the-back throws keep the pattern continuous while the body revolves around paths that stay put in the room. A sport programme treats those body throws as expected technique for that class. Wallplane backward no-beat cascade and the continuous turn remain hard tasks that use body throws. In a prop-mediated controlled plane break the body stays approximately fixed while the poi planes are redirected ninety degrees by specific hand movements: the same shift of body-relative plane class, reached by changing angular momentum. In a coupled transition both change together, and a ninety-degree body-relative shift might be forty-five of body and forty-five of prop plane.

Control therefore means more than tidy planes. Advanced control includes the ability to retain a plane against disturbance and to break a plane while keeping authorship of the movement. A performer fails when the plane changes contrary to the declared task; a plane-preserving requirement also fails when the props are turned and body motion disguises the redirection. Crossing throws used to preserve orbits during a declared body turn belong to the authorship of that class.

## Pirouette parity and numbers

Pirouettes should be divided into orientation-preserving and orientation-inverting classes. A turn through an even number of half-turns returns the performer to the original facing; an odd number inverts it. For normally rotating poi, even-half-turn pirouettes tend to preserve the body-relative direction class; odd-half-turn pirouettes tend to invert it, and that default relation must be stated. Recognised odd-turn variants are separate graded skills: accept the direction inversion (backward → forward), keep the original direction with a flat throw, correct with overspin, or restore direction by a post-catch reversal. The phrase “one-up 180” by itself is too thin.

Numbers progression should keep three poi as the core vocabulary, four as intermediate density, and five as the highest principal number, while mixing fundamentals, siteswaps, pirouettes, body throws, and plane tasks across grades. Four begins after the three-poi foundation. Five distinguishes flash from stable control, acquisition from endurance, and modality change from mere survival. [IJA Numbers Championships](https://festival.juggle.org/ija-numbers-championships-rules/) remain organised around balls, rings, clubs, and bounced balls; a sport programme for poi will have to be assembled separately from existing numbers tracks. Poi juggling already has public recognition elsewhere: [Chris Kelly’s IJA Tricks of the Month](https://www.juggle.org/ija-tricks-of-the-month-june-2016-usa-by-chris-kelly/) and [David Cain’s history of poi in the juggling community](https://www.juggle.org/the-history-of-poi-swinging-within-the-juggling-community/) record an “unexplored” juggling frontier and a late entry into juggling culture.

## Equipment, freedom, and reference

Poi vary more than competition balls and often more than clubs or rings: tether length, diameter, and elasticity, head mass and diameter, handle mass and type, swivel presence, drag. Complete standardisation would ease comparison, but would sharply narrow the available choice of equipment and of the technical forms that go with it. A better first convention is declaration plus bounded classes: short, medium, and long tether; permitted head-mass range; limited elasticity; no automatic retractors; declared swivel use; equivalent props within one numbered pattern. Records should state the equipment, and variation should stay visible.
...
1. Only repeated throw-and-dwell patterns belong to the core discipline.
2. Three poi define the foundation; four intermediate density; five the highest principal number.
...
10. A certificate confirms completion of specific tasks.
...
The greater flexibility of poi is a reason to construct the discipline carefully from the beginning. A working convention should stay narrow enough to support comparison and modest enough to admit that it governs only one region of practice. Technical convention is a surface for comparison; poi can enter sport juggling when their freedoms are declared, and the central task is to determine which of their many possible movements are being compared, and to make that comparison honest.

This essay continues [On the Modality of Spinning](20260612120000_o_modalnosti_krucheniya_en.html).

## Sources and related reading

1. [Boris Fontanov — On the Modality of Spinning](20260612120000_o_modalnosti_krucheniya_en.html)
...
Editorial source mirrors the published HTML. Key evidence hedges after source review (2 Aug 2026):

- Bow `1`/`2` digit rules attributed to the accompanying catalogue for the hundred-siteswaps video, not the bare YouTube description.
- Pendulum-first cascade order marked as programme preference; Bow course cited for no-beat before forward.
- Varpanen woven as spin-state description vs toss sport surface.
