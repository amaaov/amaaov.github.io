...
In such weather a person does not come to another person but to a picture assembled from fragments. Then the meeting does not match the expectation, and people begin to fit the living thing to an image already prepared.
...
There what mattered was the process of humanization itself, the slow return of a person from scheme back into face, voice, choice, and biography.
...
There is testing in friendship, but it does not resemble certification. There a person is tested by time, attention, presence, the ability to endure difference.
...
A person with spark could be turned into a meme. A person with pain: a case study. A person with a different tempo: a problem. A person with criticism: a threat. And the more stories there were around, the less direct hearing remained.
...
Ug walked on without turning this small scene into a final philosophy, because final philosophies too quickly begin to behave like institutions.
