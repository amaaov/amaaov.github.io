...
(function () {
  ...
  var GRADE_COSMOLOGY = {
    fw1: {
      ...
      capability: "Старт и остановка с плечами вперёд, свободный накат",
    ...
    fw2: {
      seal: "FW2",
      body: "Венера",
      rule: "Тормоз · свободный накат",
      motto: "ДВОЙНАЯ ФАЗА",
      capability: "Остановки с плечами вперёд, импульс и накат вместе",
    ...
    fw4: {
      ...
      capability: "Волны, хоп, длинный накат, задания по выбору",
