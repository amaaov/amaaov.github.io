...
[«Кризис хобби»](20260808121000_hobby_crisis.html) уже показывает на материале сообщества YouTube о косметике, как предпринимательские практики отдельных участников меняют нормы для остальных ([Мардон, Кокер и Даунт, 2023](https://academic.oup.com/jcr/article/50/3/617/6978199)); здесь достаточно механизма: норма растёт через взаимное наблюдение и адаптацию среды задолго до формального требования.
